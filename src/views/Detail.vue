            ...
            <div class="content1">
                <div class="content1-sum">
                    ...
                    <div class="content1-right">
                        <p style="margin-top: 0">书名:{{prod.name}}</p>
                        <p>类型:{{prod.type}}</p>
                        <p>ISBN:{{prod.ISBN}}</p>
                        <p>出版社:{{prod.press}}</p>
                        <p>出版时间:{{prod.time}}</p>
                    ...
                    <div class="grade">
                        ...
                        <div class="grade-content">
                            <div class="grade-content1">
                                <Rate disabled allow-half v-model="grade2" class="grade1"></Rate>
                                <span style="font-size:40px;margin-left:40px;color: #f5a623">{{ grade2 }}</span>
                                <p style="margin-left: 10px;color: #cccccc">已有<span style="color: rgba(67,142,179,1)">{{sum}}</span>人参与评分(在星星上滑动评分)
                                </p>
                            </div>

                            <div @click="grade" class="grade-content2">
                                        ...
                                        <div class="caption">
                                            ...
                                            <p class="p6">
                                                ...
                                                <a style="color: rgba(81,90,110,1);margin-left: 5px">
                                                    <Icon type="md-thumbs-down" style="font-size: 20px"/>
                                                </a>
        ...
        data() {
            return {
                ...
                personalinfo: [
                    ...
                    //     name: '回家部部长',
                    //     sum3: '1',
                    //     imgurl: 'https://www.liuli.se/wp/wp-content/uploads/wpdiscuz/cache/gravatars/94455db8a782f8c3e446af3bf69a8a36.gif',
                    //     content: '期待下一作',
                    //     time: '2019年06月5日  上午8:55',
                    //     show: 'false',
                    //     show2: 'false',
                    //     show3: 'false'
                    // },
                    ...
                    //     name: '聪明的戴佳伟',
                    //     sum3: '1',
                    //     imgurl: 'https://www.liuli.se/wp/wp-content/uploads/wpdiscuz/cache/gravatars/39564b2fe181c3ee91adf04dcd53d8f2.gif',
                    //     content: '有人在吗',
                    //     time: '2019年09月11日  下午20:10',
                    //     show: 'false',
                    //     show2: 'false',
                    //     show3: 'false'
                    // },
