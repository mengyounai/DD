<template>
    ...
    <div class="main">
        ...
        <p style="margin-bottom:5px;">
            <Input  prefix="ios-book" v-model="username" class="input" placeholder="你的用户名" @on-blur="validateUser()" />
        </p>
        ...
        <p style="margin-top: 25px"><Checkbox v-model="save">记住我</Checkbox>
        ...
        <p>
           ...
           <Button type="primary" class="btn" to="/register" style="background: rgba(110,231,14,0.05);color: black">注册</Button>
        </p>
      </div>
      </div>
    </div>
...
<style scoped>
    *{
    ...
    .content{width: 100%;height:330px;display: flex}
    .login{width:40%;height:100%;display: flex;justify-content: center; padding:20px 30px; border-radius:5px; text-align:left;}
    .login .input{width:400px;margin-top: 20px;}
    .login .btn{width:180px;height: 40px; margin-right:20px;margin-top: 20px;}
    .login p,.login h3{margin-bottom:10px;}
</style>
