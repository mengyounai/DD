...
<style scoped>
    ...
    .content{width: 100%;height:330px;margin-left: 480px;}
    .register{width:60%;margin-top: 50px;  border-radius:5px; text-align:left;}
    .err{color:#ed4014;}
    .register .input{width:350px;}
    .register .btn{width:350px; margin-right:20px;height: 40px;margin-top: -10px}
    .register p,.register h3{margin-bottom:15px;margin-top: 30px;}
</style>